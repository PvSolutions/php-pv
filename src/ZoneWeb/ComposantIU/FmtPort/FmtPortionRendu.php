...
namespace Pv\ZoneWeb\ComposantIU\FmtPort ;

class FmtPortionRendu extends \Pv\ZoneWeb\ComposantIU\ComposantIU
{
	...
	{
		$encodeur = new \Pv\ZoneWeb\ComposantIU\EncPortionRendu\DateFr($prefixe) ;
