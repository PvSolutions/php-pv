...
class FilArianeDonnees extends \Pv\ZoneWeb\ComposantIU\ComposantDonneesSimple
{
	...
	protected function CtnsLienRendu()
	{
		...
		{
			$ctnLien = new \Pv\ZoneWeb\ComposantIU\CtnLienFilAriane() ;
	...
	{
		$lien = new \Pv\ZoneWeb\ComposantIU\DefLienFilAriane() ;
