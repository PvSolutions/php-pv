...
class PortionDonnees extends \Pv\ZoneWeb\ComposantIU\ComposantDonneesSimple
{
	...
	protected function ObtientEncodeurs()
	{
		...
		if($this->EncoderUrl)
		{
			$encodeurs[] = new \Pv\ZoneWeb\ComposantIU\EncPortionRendu\Url($this->PrefixeEncUrl) ;
		}
		if($this->EncoderHtmlEnt)
		{
			$encodeurs[] = new \Pv\ZoneWeb\ComposantIU\EncPortionRendu\Html($this->PrefixeEncHtmlEnt) ;
		}
		return $encodeurs ;
	}
	public function & InsereEncodeurDateFr($nomParams=array())
	{
		$encodeur = new \Pv\ZoneWeb\ComposantIU\EncPortionRendu\DateFr() ;
	...
	{
		$encodeur = new \Pv\ZoneWeb\ComposantIU\EncPortionRendu\NonVide($prefixe) ;
		$encodeur->NomParams = $nomParams ;
...
class PortionDonnees extends \Pv\ZoneWeb\ComposantIU\PortionDonnees
{
}