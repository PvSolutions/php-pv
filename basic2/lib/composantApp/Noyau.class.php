<?php
	...
	if(! defined('COMPOSANT_APP_NOYAU_BASIC2'))
	{
		define('COMPOSANT_APP_NOYAU_BASIC2', 1) ;
		
		class ComposantAppBaseBasic2 extends PvElementApplication
		{
		...
		class ActionAppBaseBasic2 extends ComposantAppBaseBasic2
		{
			protected $_Result ;
			protected $_Param ;
			public $Titre ;
			...
			{
				return new ParamBaseBasic2($params) ;
			}
