<?php
	...
	if(! defined('SCRIPT_ENTITES_BOOTSTRAP3'))
	{
		define('SCRIPT_ENTITES_BOOTSTRAP3', 1) ;
		
		class ScriptListeEntitesBootstrap3 extends ScriptListBaseBootstrap3
		{
		...
		class ScriptEditEntiteBootstrap3 extends ScriptEditBaseBootstrap3
		{
		...
		class ScriptAjoutEntiteBootstrap3 extends ScriptEditEntiteBootstrap3
		{
		...
		class ScriptModifEntiteBootstrap3 extends ScriptEditEntiteBootstrap3
		{
			public $PourAjout = 0 ;
		...
		class ScriptSupprEntiteBootstrap3 extends ScriptEditEntiteBootstrap3
		{
			public $PourAjout = 0 ;
