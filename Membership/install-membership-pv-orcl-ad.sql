...
CREATE TABLE "membership_member" (
  ...
  "ad_activated" number(1) default 0 NOT NULL,
  "profile_id" number NULL,
  "ad_server_id" number NULL,
...
CREATE SEQUENCE  "membership_member_seq" MINVALUE 1 INCREMENT BY 1 START WITH 3 ;
/
CREATE SEQUENCE  "membership_profile_seq" MINVALUE 1 INCREMENT BY 1 START WITH 3 ;
/
CREATE SEQUENCE  "membership_role_seq" MINVALUE 1 INCREMENT BY 1 START WITH 3 ;
/
CREATE SEQUENCE  "membership_privilege_seq" MINVALUE 1 INCREMENT BY 1 START WITH 5 ;
/
...
--
-- Structure de la table "membership_ad_server"
--

CREATE TABLE "membership_ad_server" (
  "id" number NOT NULL,
  ...
  "dn" varchar(50) NULL,
  CONSTRAINT membership_ad_server_pk PRIMARY KEY ("id")
) ;
/

CREATE SEQUENCE  "membership_ad_server_seq" MINVALUE 1 INCREMENT BY 1 ;
/

create or replace TRIGGER membership_ad_server_trg
BEFORE INSERT
ON "membership_ad_server"
REFERENCING NEW AS New OLD AS Old
FOR EACH ROW
BEGIN
  select case when :new."id" is null then "membership_ad_server_seq".nextval else :new."id" end into :new."id" from dual ;
END membership_ad_server_trg ;
/
