<?php
	...
	if(! defined('COMPOSANT_APP_NOYAU_BOOTSTRAP2'))
	{
		define('COMPOSANT_APP_NOYAU_BOOTSTRAP2', 1) ;
		
		class ComposantAppBaseBootstrap2 extends PvElementApplication
		{
		...
		class ParamActionAppBootstrap2
		{
			public $Args = array() ;
		...
		class ResultActionAppBootstrap2
		{
			public $Valeur = '' ;
		...
		class ActionAppBaseBootstrap2 extends ComposantAppBaseBootstrap2
		{
			protected $_Result ;
			protected $_Param ;
			public $Titre ;
			...
			{
				$this->_Result = new ResultBootstrap2() ;
			...
			{
				return new ParamBaseBootstrap2($params) ;
			}
