<?php
	...
	{
		define('SCRIPT_NOYAU_BOOTSTRAP2', 1) ;
		
		class ScriptBaseBootstrap2 extends PvScriptWebSimple
		{
...
<div class="panel-heading">'.$ctnLiensPrinc.'</div>
			...
			{
				return new TablDonneesBaseBootstrap2() ;
			}
			public function CreeFormPrinc()
			{
				return new FormDonneesBaseBootstrap2() ;
			}
			public function CreeGrillePrinc()
			{
				return new GrilleDonneesBaseBootstrap2() ;
			}
		...
		class ScriptListBaseBootstrap2 extends ScriptBaseBootstrap2
		{
			public $TablPrinc ;
			...
			{
				$this->DessinateurFiltresSelection = new DessinFiltresPrincBootstrap2() ;
			...
			protected function DetermineTablPrinc()
			{
				...
				$this->TablPrinc->SourceValeursSuppl = new SrcValsSupplLgnDonneesBootstrap2() ;
		...
		class SrcValsSupplLgnDonneesBootstrap2 extends PvSrcValsSupplLgnDonnees
		{
		...
		class ScriptEditBaseBootstrap2 extends ScriptBaseBootstrap2
		{
			public $FormPrinc ;
			protected $PourAjout = 1 ;
			protected $FormPrincEditable = 1 ;
			protected $InscrireCmdAnnulFormPrinc = 1 ;
			protected $NomClasseCmdAnnulFormPrinc = "CmdAnnulEditBaseBootstrap2" ;
			protected $LibelleCmdAnnulFormPrinc ;
			protected $InscrireCmdExecFormPrinc = 1 ;
			protected $NomClasseCmdExecFormPrinc = "CmdExecEditBaseBootstrap2" ;
			...
			protected function DetermineFormPrinc()
			{
				...
				$this->FormPrinc->DessinateurFiltresEdition = new DessinFiltresPrincBootstrap2() ;
				$this->ChargeFormPrincAuto() ;
				$this->ChargeFormPrinc() ;
				$this->FormPrinc->CommandeExecuter->InsereNouvCritere(new CritExecEditBaseBootstrap2()) ;
			}
			public function DessineFiltresPrinc(& $dessinateur)
			{
				return '' ;
		...
		class DessinFiltresPrincBootstrap2 extends PvDessinFiltresDonneesBootstrap
		{
		...
		class CmdAnnulEditBaseBootstrap2 extends PvCommandeExecuterBase
		{
		...
		class CmdExecEditBaseBootstrap2 extends PvCommandeAnnulerBase
		{
			protected function ExecuteInstructions()
			{
		...
		class CritExecEditBaseBootstrap2 extends PvCritereBase
		{
		...
		class ScriptConsultBaseBootstrap2 extends ScriptBaseBootstrap2
		{
			public $LgnPrinc ;
			public function EstAccessible()
			{
