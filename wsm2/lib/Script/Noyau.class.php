<?php
	...
	if(! defined('PV_SCRIPT_NOYAU_WSM'))
	{
		define('PV_SCRIPT_NOYAU_WSM', 1) ;
		
		class PvScriptBaseWsm extends PvScriptWebSimple
		{
...
<div class="panel-heading">'.$ctnLiensPrinc.'</div>
			...
			{
				return new TablDonneesBaseWsm() ;
			}
			public function CreeFormPrinc()
			{
				return new FormDonneesBaseWsm() ;
			}
			public function CreeGrillePrinc()
			{
				return new GrilleDonneesBaseWsm() ;
			}
		}
		
		class PvScriptListBaseWsm extends ScriptBaseWsm
		{
			public $TablPrinc ;
			...
			{
				$this->DessinateurFiltresSelection = new PvDessinFiltresPrincWsm() ;
			...
			protected function DetermineTablPrinc()
			{
				...
				$this->TablPrinc->SourceValeursSuppl = new PvSrcValsSupplLgnDonneesWsm() ;
		...
		class PvSrcValsSupplLgnDonneesWsm extends PvSrcValsSupplLgnDonnees
		{
		...
		class PvScriptEditBaseWsm extends ScriptBaseWsm
		{
			public $FormPrinc ;
			protected $PourAjout = 1 ;
			protected $FormPrincEditable = 1 ;
			protected $InscrireCmdAnnulFormPrinc = 1 ;
			protected $NomClasseCmdAnnulFormPrinc = "PvCmdAnnulEditBaseWsm" ;
			protected $LibelleCmdAnnulFormPrinc ;
			protected $InscrireCmdExecFormPrinc = 1 ;
			protected $NomClasseCmdExecFormPrinc = "PvCmdExecEditBaseWsm" ;
			...
			protected function DetermineFormPrinc()
			{
				...
				$this->FormPrinc->DessinateurFiltresEdition = new PvDessinFiltresPrincWsm() ;
				$this->ChargeFormPrincAuto() ;
				$this->ChargeFormPrinc() ;
				$this->FormPrinc->CommandeExecuter->InsereNouvCritere(new PvCritExecEditBaseWsm()) ;
			}
			public function DessineFiltresPrinc(& $dessinateur)
			{
				return '' ;
		...
		class PvDessinFiltresPrincWsm extends PvDessinFltsDonneesHtml
		{
		...
		class PvCmdAnnulEditBaseWsm extends PvCommandeExecuterBase
		{
		...
		class PvCmdExecEditBaseWsm extends PvCommandeAnnulerBase
		{
			protected function ExecuteInstructions()
			{
		...
		class PvCritExecEditBaseWsm extends PvCritereBase
		{
		...
		class PvScriptConsultBaseWsm extends PvScriptBaseWsm
		{
			public $LgnPrinc ;
