<?php
	...
	if(! defined('COMPOSANT_APP_NOYAU_BOOTSTRAP1'))
	{
		define('COMPOSANT_APP_NOYAU_BOOTSTRAP1', 1) ;
		
		class ComposantAppBaseBootstrap1 extends PvElementApplication
		{
		...
		class ParamActionAppBootstrap1
		{
			public $Args = array() ;
		...
		class ResultActionAppBootstrap1
		{
			public $Valeur = '' ;
		...
		class ActionAppBaseBootstrap1 extends ComposantAppBaseBootstrap1
		{
			protected $_Result ;
			protected $_Param ;
			public $Titre ;
			...
			{
				$this->_Result = new ResultBootstrap1() ;
			...
			{
				return new ParamBaseBootstrap1($params) ;
			}
