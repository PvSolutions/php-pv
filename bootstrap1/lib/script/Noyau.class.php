<?php
	...
	{
		define('SCRIPT_NOYAU_BOOTSTRAP1', 1) ;
		
		class ScriptBaseBootstrap1 extends PvScriptWebSimple
		{
			...
			{
				return new TablDonneesBaseBootstrap1() ;
			}
			public function CreeFormPrinc()
			{
				return new FormDonneesBaseBootstrap1() ;
			}
			public function CreeGrillePrinc()
			{
				return new GrilleDonneesBaseBootstrap1() ;
			}
		}
		
		class ScriptListBaseBootstrap1 extends ScriptBaseBootstrap1
		{
			public $TablPrinc ;
			...
			{
				$this->DessinateurFiltresSelection = new DessinFiltresPrincBootstrap1() ;
		...
		class SrcValsSupplLgnDonneesBootstrap1 extends PvSrcValsSupplLgnDonnees
		{
		...
		class ScriptEditBaseBootstrap1 extends ScriptBaseBootstrap1
		{
			public $FormPrinc ;
			protected $PourAjout = 1 ;
			protected $FormPrincEditable = 1 ;
			protected $InscrireCmdAnnulFormPrinc = 1 ;
			protected $NomClasseCmdAnnulFormPrinc = "CmdAnnulEditBaseBootstrap1" ;
			protected $LibelleCmdAnnulFormPrinc ;
			protected $InscrireCmdExecFormPrinc = 1 ;
			protected $NomClasseCmdExecFormPrinc = "CmdExecEditBaseBootstrap1" ;
			...
			protected function DetermineFormPrinc()
			{
				...
				$this->FormPrinc->DessinateurFiltresEdition = new DessinFiltresPrincBootstrap1() ;
		...
		class DessinFiltresPrincBootstrap1 extends PvDessinFiltresDonneesBootstrap
		{
		...
		class CmdAnnulEditBaseBootstrap1 extends PvCommandeExecuterBase
		{
		...
		class CmdExecEditBaseBootstrap1 extends PvCommandeAnnulerBase
		{
			protected function ExecuteInstructions()
			{
		...
		class ScriptConsultBaseBootstrap1 extends ScriptBaseBootstrap1
		{
			public $LgnPrinc ;
