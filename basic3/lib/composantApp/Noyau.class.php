<?php
	...
	if(! defined('COMPOSANT_APP_NOYAU_BASIC3'))
	{
		define('COMPOSANT_APP_NOYAU_BASIC3', 1) ;
		
		class ComposantAppBaseBasic3 extends PvElementApplication
		{
		...
		class ActionAppBaseBasic3 extends ComposantAppBaseBasic3
		{
			protected $_Result ;
			protected $_Param ;
			public $Titre ;
			...
			{
				return new ParamBaseBasic3($params) ;
			}
