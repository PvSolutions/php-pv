<?php
	...
	{
		define('SCRIPT_NOYAU_PUBL_WSM2', 1) ;
		
		class ScriptBasePublWsm2 extends PvScriptWebSimple
		{
			public $ActiverAutoRafraich = 0 ;
			public $DelaiAutoRafraich = 60 ;
			public $NomDocumentWeb = "connecte" ;
			public $NecessiteMembreConnecte = 1 ;
			public $LargeurBsCompPrinc = "col-sm-12 col-xs-8 col-md-8" ;
...
<div class="panel-heading">'.$ctnLiensPrinc.'</div>
			...
			{
				return new TablDonneesBasePublWsm2() ;
			}
			public function CreeFormPrinc()
			{
				return new FormDonneesBasePublWsm2() ;
			}
			public function CreeGrillePrinc()
			{
				return new GrilleDonneesBasePublWsm2() ;
			}
		}
		
		class ScriptListBasePublWsm2 extends ScriptBasePublWsm2
		{
			public $TablPrinc ;
			...
			public $LargeurBsCompPrinc = "col-sm-12 col-xs-12" ;
			...
			{
				$this->DessinateurFiltresSelection = new DessinFiltresPrincPublWsm2() ;
			...
			protected function DetermineTablPrinc()
			{
				...
				$this->TablPrinc->SourceValeursSuppl = new SrcValsSupplLgnDonneesPublWsm2() ;
...
<div class="'.$this->LargeurBsCompPrinc.'">'.PHP_EOL ;
		...
		class SrcValsSupplLgnDonneesPublWsm2 extends PvSrcValsSupplLgnDonnees
		{
		...
		class ScriptEditBasePublWsm2 extends ScriptBasePublWsm2
		{
			public $FormPrinc ;
			protected $PourAjout = 1 ;
			protected $FormPrincEditable = 1 ;
			protected $InscrireCmdAnnulFormPrinc = 1 ;
			protected $NomClasseCmdAnnulFormPrinc = "CmdAnnulEditBasePublWsm2" ;
			protected $LibelleCmdAnnulFormPrinc ;
			protected $InscrireCmdExecFormPrinc = 1 ;
			protected $NomClasseCmdExecFormPrinc = "CmdExecEditBasePublWsm2" ;
			...
			protected function DetermineFormPrinc()
			{
				...
				$this->FormPrinc->DessinateurFiltresEdition = new DessinFiltresPrincPublWsm2() ;
				$this->ChargeFormPrincAuto() ;
				$this->ChargeFormPrinc() ;
				if($this->InscrireCmdExecFormPrinc == 1)
				{
					$this->FormPrinc->CommandeExecuter->InsereNouvCritere(new CritExecEditBasePublWsm2()) ;
				}
			}
			public function DessineFiltresPrinc(& $dessinateur)
			{
...
<div class="'.$this->LargeurBsCompPrinc.'">'.PHP_EOL ;
		...
		class DessinFiltresPrincPublWsm2 extends PvDessinFiltresDonneesBootstrap
		{
		...
		class CmdAnnulEditBasePublWsm2 extends PvCommandeExecuterBase
		{
		...
		class CmdExecEditBasePublWsm2 extends PvCommandeAnnulerBase
		{
			protected function ExecuteInstructions()
			{
		...
		class CritExecEditBasePublWsm2 extends PvCritereBase
		{
		...
		class ScriptConsultBasePublWsm2 extends ScriptBasePublWsm2
		{
			public $LgnPrinc ;
