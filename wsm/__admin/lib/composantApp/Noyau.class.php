<?php
	...
	if(! defined('COMPOSANT_APP_NOYAU_WSM2'))
	{
		define('COMPOSANT_APP_NOYAU_WSM2', 1) ;
		
		class ComposantAppBaseWsm2 extends PvElementApplication
		{
		...
		class ActionAppBaseWsm2 extends ComposantAppBaseWsm2
		{
			protected $_Result ;
			protected $_Param ;
			public $Titre ;
			...
			{
				return new ParamBaseWsm2($params) ;
			}
